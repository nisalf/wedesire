var snfApp = angular.module("reportModule", ['ui.bootstrap']);
...
var reportController = ['$scope', '$cookieStore', '$rootScope','$http', function ($scope, $cookieStore,$rootScope,$http) 
{
...
snfApp.controller("reportController", reportController);